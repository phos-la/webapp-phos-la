      ...
      <div className="section-inner">
        <div className="section-head">
          ...
          <p className="section-sub">
            IV ketamine infusions, ketamine-assisted psychotherapy, and IV
            wellness &mdash; each tailored to where you are right now.
          </p>
        </div>
        ...
        <div className="three-cards">
          <article className="card-feature">
            ...
            <p className="card-feature-body">
              A standard series of six subanesthetic infusions over two to three
              weeks, overseen by Dr. Christa Riley, board-certified
              anesthesiologist. Your PA meets with you before and after every
              session, adjusting dosing, duration, and supportive therapies
          ...
          <article className="card-feature">
            ...
            <p className="card-feature-body">
              Bring your existing therapist to the session, or we&apos;ll
              connect you with one from our referral network. No in-house
              upsell, no added cost for the therapy component. Your mental
              health work and your infusion stay integrated from day one.
            </p>
          </article>
          ...
          <article className="card-feature">
            ...
            <p className="card-feature-body">
              NAD+, Myers&apos; Cocktail, glutathione, and other IV wellness
              infusions administered by our clinical team. Available as a
              standalone service or alongside your ketamine protocol to support
