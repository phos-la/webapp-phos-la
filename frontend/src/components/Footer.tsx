      ...
      <div className="footer-row">
        <div className="footer-col">
          ...
          <p className="footer-line">
            <strong>Phos Wellness</strong> &nbsp;&mdash;&nbsp; 1762 Westwood Blvd, Ste 320, Los
            Angeles, CA 90024
          </p>
          <p className="footer-line">
            <a href="tel:4242784241" style={{ color: 'inherit' }}>
              (424) 278-4241
            </a>
            &nbsp;&nbsp;&middot;&nbsp;&nbsp;
            <a href="mailto:support@ketaminehealing.com" style={{ color: 'inherit' }}>
              support@ketaminehealing.com
            </a>
          </p>
          <p className="footer-line is-small" style={{ marginTop: 8 }}>
            &copy; {new Date().getFullYear()} Ketamine Healing Clinic of Los Angeles. IV ketamine
            for mood disorders is an off-label use. Spravato (esketamine) is FDA-approved for TRD.
          </p>
          <div className="footer-socials">
            <a
              href="https://www.instagram.com/ketaminehealingla"
            ...
            <a
              href="https://www.facebook.com/ketaminehealingla"
              aria-label="Facebook"
              target="_blank"
              rel="noopener noreferrer"
            >
