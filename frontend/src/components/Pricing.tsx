      ...
      <div className="section-inner">
        <div className="section-head">
          ...
          <p className="section-sub">
            Every session includes PA consultation before and after, plus any supportive therapies
            adjusted to your protocol. No surprise line items.
          </p>
        </div>
        ...
        <div className="pricing-grid">
          ...
          <article className="price-card">
            ...
            <p className="price-desc">
              One standalone IV ketamine session with full clinical support
            </p>
          ...
          <article className="price-card is-featured">
            <svg className="price-card-leaves" viewBox="0 0 110 50" fill="none" aria-hidden="true">
              <path
        ...
        <div className="price-callout">
          <div className="price-callout-text">
            ...
            <span>
              Not sure where to start? A free 15-minute call with our team will walk you through
              candidacy, options, and what to expect before you commit to anything.
            </span>
          </div>
