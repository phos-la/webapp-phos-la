    ...
    <section className="hero" data-screen-label="01 Hero">
      <div className="hero-inner">
        ...
        <p className="hero-sub">
          IV ketamine therapy in a private Los Angeles practice &mdash; a licensed provider
          evaluates your response <em>before and after every infusion</em>, adjusting your treatment
          in real time.
        </p>
          ...
          >
            ...
            <div className="hero-image-overlay">
              ...
              <p className="hero-image-body">
                Most clinics hand you off to a nurse and check in periodically. At Phos, your PA is
                there before and after every session, adjusting your dosing, duration, and
                supportive therapies based on how you&apos;re actually responding. Led by Dr.
                Christa Riley, board-certified anesthesiologist and military veteran.
              </p>
            </div>
          </figure>
        </div>
